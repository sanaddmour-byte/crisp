...
export default function OperationsGear({ className = "" }: IllustrationProps) {
  return (
    ...
    >
      ...
      <rect x="0" y="0" width="480" height="480" fill="url(#og-grid)" opacity="0.5" />
      ...
      <path
        ...
        opacity="0.6"
      />
      <path d="M170 130l50 70h-100z" stroke="#F5F2ED" strokeWidth="1.75" opacity="0.6" />
      <path d="M120 240H220M120 280H220" stroke="#F5F2ED" strokeWidth="1" opacity="0.35" />
      ...
      <g stroke="#F5F2ED" strokeWidth="1.75" strokeLinecap="round" opacity="0.65">
