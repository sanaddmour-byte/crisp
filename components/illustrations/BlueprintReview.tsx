...
export default function BlueprintReview({ className = "" }: IllustrationProps) {
  return (
    ...
    >
      ...
      <rect x="0" y="0" width="480" height="480" fill="url(#bp-grid)" opacity="0.45" />

      {/* Elevation outline */}
      <rect x="110" y="120" width="200" height="240" stroke="#F5F2ED" strokeWidth="2.25" opacity="0.9" />
      <path d="M110 170H310M110 220H310M110 270H310M110 320H310" stroke="#F5F2ED" strokeWidth="1.25" opacity="0.5" />
      <path d="M160 120V360M210 120V360M260 120V360" stroke="#F5F2ED" strokeWidth="1.25" opacity="0.5" />

      {/* Dimension ticks */}
      <path d="M110 380h200M110 375v10M310 375v10" stroke="#F5F2ED" strokeWidth="1.5" opacity="0.7" />
      <path d="M85 120v240M80 120h10M80 360h10" stroke="#F5F2ED" strokeWidth="1.5" opacity="0.7" />
      ...
      {/* Red-flag pennant */}
      <path d="M370 120v90" stroke="#F5F2ED" strokeWidth="2.25" strokeLinecap="round" opacity="0.85" />
